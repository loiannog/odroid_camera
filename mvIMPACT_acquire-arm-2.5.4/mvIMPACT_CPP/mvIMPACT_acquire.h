...
#	ifdef MVIMPACT_H_
		...
		*/
		...
		public:
			...
			explicit ImpactAcquireException(	/// [in] The string representation of the error.
			 ...
			 * is the error codes corresponding enum name.
			 */
			static std::string getErrorCodeAsString(	/// [in] The error code to query a string representation for.
														int errorCode ) { return DMR_ErrorCodeToString( errorCode ); }
		};
#	else
		//-----------------------------------------------------------------------------
		/// \brief An base class for exceptions generated by mvIMPACT Acquire.
...
#	endif // #ifdef MVIMPACT_H_
	...
	public:
		...
		explicit EDeviceManager(	/// [in] The error string.
									const std::string& errorString,
									/// [in] The error origin.
									const std::string& errorOrigin,
									/// [in] The error code.
	...
	public:
		...
		explicit EPropertyHandling(	/// [in] The error string.
									const std::string& errorString,
									/// [in] The error origin.
									const std::string& errorOrigin,
									/// [in] The error code.
	...
	protected:
		...
		explicit EComponent(	/// [in] The error string.
								const std::string& errorString,
								/// [in] The error origin.
								const std::string& errorOrigin,
								/// [in] The error code.
	...
	protected:
		...
		explicit EProperty( /// [in] The error string.
							const std::string& errorString,
							/// [in] The error origin.
							const std::string& errorOrigin,
							/// [in] The error code.
	...
	protected:
		...
		explicit EPropertyList( /// [in] The error string.
								const std::string& errorString,
								/// [in] The error origin.
								const std::string& errorOrigin,
								/// [in] The error code.
	...
	protected:
		...
		explicit EMethod(	/// [in] The error string.
							const std::string& errorString,
							/// [in] The error origin.
							const std::string& errorOrigin,
							/// [in] The error code.
	...
	public:
		...
		static void raiseException(	/// [in] The name of the function this exception was raised from.
...
public:
	...
	explicit Component(	/// [in] A valid handle to a component object
	 ...
	 */
	std::string flagsAsString(	/// [in] A user definable string to separate the individual flags.
								/// 
	 ...
	 */
	static TComponentType type(	/// [in] The component the type shall be retrieved for
								HOBJ hObj )
	{
	 ...
	 */
	static std::string visibilityAsString(	/// [in] The visibility to query the string representation for
											TComponentVisibility visibility )
	{
		size_t bufSize = DEFAULT_STRING_SIZE_LIMIT;
		char* pBuf = new char[bufSize];
	...
	unsigned int selectingFeatureCount( void ) const
	{
		 ...
		 * \return The number of features selected by the current one.
		 */
		unsigned int selectedFeatures(	/// [out] An array that will retrieve the list of components that are selected by the current one.
		 ...
		 * \return The number of features selecting the current one.
		 */
		unsigned int selectingFeatures(		/// [out] An array that will retrieve the list of components that are selecting the current one.
											std::vector<Component>& v ) const
		{
	 ...
	 */
#ifndef DOTNET_ONLY_CODE
	Component selectedFeature(	/// [in] The index for the component to query.
								unsigned int index ) const
	{
		return Component(queryFeature( OBJ_GetSelectedFeatures, static_cast<int>(index) ));
	}
#else
	HOBJ selectedFeature(	/// [in] The index for the component to query.
							unsigned int index ) const
	{
	 ...
	 */
#ifndef DOTNET_ONLY_CODE
	Component selectingFeature(	/// [in] The index for the component to query.
								unsigned int index ) const
	{
		return Component(queryFeature( OBJ_GetSelectingFeatures, static_cast<int>(index) ));
	}
#else
	HOBJ selectingFeature(	/// [in] The index for the component to query.
							unsigned int index ) const
	{
...
public:
	...
	explicit ComponentCallback(	/// [in] A pointer to user specific data bound to this callback. This data will
	 ...
	 *  - false otherwise
	 */
	bool isComponentRegistered(	/// [in] The compoent that shall be tested against this callback
	 ...
	 *  - false otherwise
	 */
	bool registerComponent(	/// [in] The component to register for this callback
							Component c )
	{
	 ...
	 *  - false otherwise
	 */
	bool unregisterComponent(	/// [in] The component to unregister from this callback
								Component c )
	{
	 ...
	 */
#if defined(WRAP_DOTNET) || defined(DOTNET_ONLY_CODE)
	virtual void execute(	/// [in] The component that did cause the callback to be executed
							Component& c,
...
public:
	...
	explicit ComponentLocatorBase(	/// [in] A unique identifier to the base list from where to start to search for
									/// the search base.
	 ...
	 */
	HLIST bindSearchBase(	/// [in] A unique identifier for the base list used to start searching the search base.
							HLIST baselist,
...
public:
	...
	explicit ComponentList(	/// [in] A valid handle to a list object
...
public:
	...
	explicit Method(	/// [in] A valid handle to method object
	 ...
	 */
	int call(	/// [in] The parameters to be passed to the function as a single string
...
public:
	 ...
	 */ 
	explicit Property(	/// [in] A valid handle to a property
	 ...
	 *  - false otherwise
	 */
	MVIMPACT_DEPRECATED_CPP( bool isConstDefined(	/// [in] The constant whose existance is in question
	 ...
	 */
	std::string readS(	/// [in] The index of the desired value(only necessary for properties containing more than one value)
						int index = 0,
	 ...
	 *  \return A string containing the data questioned.
	 */
	std::string readSArray(	/// [in] The format string telling the function how to format the result. If left empty the property uses its standard way of converting its data into a string
	...
	const Property&
#endif
					removeValue(	/// [in] The index of the value to be removed
									int index = 0 ) const
	{
		TPROPHANDLING_ERROR result;
	...
	const Property&
#endif
					resizeValArray(	/// [in] The new number of values this property shall be allowed to store
	...
	const Property&
#endif
					writeS( /// [in] The new value for this property at the given \a index
	...
	const Property&
#endif
					writeS( /// [in] A constant reference to an array containing the strings to be assigned to the property
...
public:
	...
	explicit EnumPropertyF(	/// [in] A valid handle to a float property
							HOBJ hProp ) : Property(hProp)
	{
		 ...
		 *  \return A const reference to the calling property.
		 */
		const EnumPropertyF& getTranslationDict(	/// [out] A reference to a container which will receive the data from the properties translation dictionary.
	 ...
	 */
	std::string getTranslationDictString(	/// [in] The index of the entry to read from the property.
											int index = 0 ) const
	{
		TPROPHANDLING_ERROR result = PROPHANDLING_NO_ERROR;
		size_t bufSize = DEFAULT_STRING_SIZE_LIMIT;
	 ...
	 */
	ZYX getTranslationDictValue(	/// [in] The index of the entry to read from the property.
									int index = 0 ) const
	{
		TPROPHANDLING_ERROR result = PROPHANDLING_NO_ERROR;
		double value;
		 ...
		 *  \return A const reference to the calling property.
		 */
		const EnumPropertyF& getTranslationDictStrings(	/// [out] A reference to a container to store the data read from the property into.
		 ...
		 *  \return A const reference to the calling property.
		 */
		const EnumPropertyF& getTranslationDictValues(	/// [out] A reference to a container to store the data read from the property into.
	 ...
	 */
	ZYX read(	/// [in] The index of the value to read from the property.
				int index = 0 ) const
	{
		double val;
		TPROPHANDLING_ERROR result;
	 ...
	 *  \return Nothing.
	 */
	void read(	/// [out] A reference to a container to store the data read from the property into.
	...
	const EnumPropertyF&
#endif
								write(	/// [in] The value to write to the property.
										ZYX value,
	...
	const EnumPropertyF&
#endif
							write(	/// [in] An array containing the values to write to the property.
...
public:
	...
	explicit EnumPropertyI(	/// [in] A valid handle to an integer property
							HOBJ hProp ) : Property(hProp)
	{
		 ...
		 *  \return A const reference to the calling property.
		 */
		const EnumPropertyI& getTranslationDict(	/// [out] A reference to a container which will receive the data from the properties translation dictionary.
													std::vector<std::pair<std::string, ZYX> >& sequence ) const
		{
			TPROPHANDLING_ERROR result = PROPHANDLING_NO_ERROR;
			unsigned int size = dictSize();
									...
									int index = 0 ) const
	{
		 ...
		 *  \return A const reference to the calling property.
		 */
		const EnumPropertyI& getTranslationDictStrings(	/// [out] A reference to a container to store the data read from the property into.
														std::vector<std::string>& sequence ) const
		{
			TPROPHANDLING_ERROR result = PROPHANDLING_NO_ERROR;
			unsigned int size = dictSize();
		 ...
		 *  \return A const reference to the calling property.
		 */
		const EnumPropertyI& getTranslationDictValues(	/// [out] A reference to a container to store the data read from the property into.
														std::vector<ZYX>& sequence ) const
		{
			TPROPHANDLING_ERROR result = PROPHANDLING_NO_ERROR;
			const unsigned int size = dictSize();
...
public:
	...
	explicit EnumPropertyI64(	/// [in] A valid handle to a 64-bit integer property
								HOBJ hProp ) : Property(hProp)
	{
		const TComponentType compType = type();
		if( ( compType != ctPropInt ) && ( compType != ctPropInt64 ) )
		 ...
		 *  \return A const reference to the calling property.
		 */
		const EnumPropertyI64& getTranslationDict(	/// [out] A reference to a container which will receive the data from the properties translation dictionary.
													std::vector<std::pair<std::string, ZYX> >& sequence ) const
		{
			TPROPHANDLING_ERROR result = PROPHANDLING_NO_ERROR;
			unsigned int size = dictSize();
									...
									int index = 0 ) const
	{
		 ...
		 *  \return A const reference to the calling property.
		 */
		const EnumPropertyI64& getTranslationDictStrings(	/// [out] A reference to a container to store the data read from the property into.
															std::vector<std::string>& sequence ) const
		{
			TPROPHANDLING_ERROR result = PROPHANDLING_NO_ERROR;
			unsigned int size = dictSize();
		 ...
		 *  \return A const reference to the calling property.
		 */
		const EnumPropertyI64& getTranslationDictValues(	/// [out] A reference to a container to store the data read from the property into.
															std::vector<ZYX>& sequence ) const
		{
			TPROPHANDLING_ERROR result = PROPHANDLING_NO_ERROR;
			const unsigned int size = dictSize();
...
PYTHON_ONLY(ENUM_PROPERTY(PropertyI64, EnumPropertyI64, mvIMPACT::acquire::int64_type))
	...
	public:
		...
		explicit PropertyPtr(	/// [in] A valid handle to a pointer property
								HOBJ hProp ) : Property(hProp)
		{
			if( type() != ctPropPtr )
			{
...
#	endif // DOXYGEN_SHOULD_SKIP_THIS && WRAP_ANY
		 ...
		 *  \return The value stored at \a index within the property.
		 */
		void* read(	/// [in] The index of the value to read from the property.
					int index = 0 ) const
		{
			void* val;
			TPROPHANDLING_ERROR result;
		 ...
		 *  \return A const 'self' reference.
		 */
		const PropertyPtr& write(	/// [in] The value to write to the property.
									void* value,
									/// [in] The index defining at which position to write the value.
									int index = 0 ) const
		{
		 ...
		 *  \return A const 'self' reference.
		 */
		const PropertyPtr& write(	/// [in] An array containing the values to write to the property.
...
public:
	...
	explicit PropertyS(	/// [in] A valid handle to the string property
						HOBJ hProp ) : Property(hProp)
	{
	 ...
	 */
	unsigned int binaryDataBufferSize(	/// [in] The index of the value for which to query the
	 ...
	 *  \return The value stored at \a index within the property.
	 */
	std::string read(	/// [in] The index of the value to read from the property.
	 ...
	 */
	std::string readBinary(	/// [in] The index of the value to get(if this property holds more than one value).
							int index = 0 ) const
	{
		TPROPHANDLING_ERROR result;
	...
	const PropertyS&
#endif
						writeBinary(	/// [in] A const reference to the string holding the binary data that shall
...
public:
	 ...
	 *      mvIMPACT::acquire::UserData::writeToHardware
	 */
	void deleteEntry(	/// [in] A reference to the entry to delete
	 ...
	 */
	UserDataEntry getUserDataEntry(	/// [in] The number of the entry to return
									int nr ) const
	{
		std::ostringstream oss;
		oss << "Entry" << nr;
	 ...
	 */
	void validUserDataEntryIndexes(	/// [out] A reference to the array receiving the list of valid indexes
...
public:
	 ...
	 *  - false otherwise.
	 */
	bool hasCapability(	/// [in] The capability who's presence shall be checked.
						TDeviceCapability capability ) const { return ( ( capabilities.isValid() ) ? ( ( capabilities.read() & capability ) == capability ) : false ); }
	 ...
	 */
	int setID(	/// [in] The new \a ID that shall be assigned to the device.
				int newID ) const { return DMR_SetDeviceID( m_pRefData->m_hDev, newID ); }
...
public:
	 ...
	 */
	static std::string getVersionAsString(	/// [in] Specifies the library to query information from.
											TLibraryQuery libraryQuery ) { return DMR_GetVersion( libraryQuery ); }
#if !defined(DOXYGEN_SHOULD_SKIP_THIS) && !defined(WRAP_ANY)
		 ...
		 */
		Device* operator[]( /// [in] The index of the device to be returned.
	 ...
	 */
	Device* getDevice(	/// [in] The index of the device to be returned.
						unsigned int index ) const
	{
		updateInfoVector();
	 ...
	 *  - an invalid pointer or reference otherwise.
	 */
	Device* getDeviceBySerial(	/// [in] The full serial number or the known parts of the serial number and wildcard characters.
	 ...
	 *  - an invalid pointer or reference otherwise.
	 */
	Device* getDeviceByFamily(	/// [in] The full family name of the requested device or known parts of it and wildcard characters.
	 ...
	 *  - an invalid pointer or reference otherwise.
	 */
	Device* getDeviceByProduct(	/// [in] The full product name of the requested device or known parts of it and wildcard characters.
	 ...
	 *  - an invalid pointer or reference otherwise.
	 */
	Device* getDeviceByProductAndID(	/// [in] The full product name of the requested device or known parts of it and wildcard characters.
										const std::string& product = "",
...
public:
	...
	/// \brief Constructs a new bound to the specified base list locator.
	explicit DeviceComponentLocator(	/// [in] A unique identifier to the base list from where to start to search for
										/// the search base.
										HLIST baselist ) : ComponentLocatorBase(baselist) {}
	/// \brief Constructs a new locator and searches the search base list.
	explicit DeviceComponentLocator(	/// [in] A unique identifier to the base list from where to start to search for
	...
	explicit DeviceComponentLocator(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from
	 ...
	 *  \return The unique identifier of the new search base.
	 */
	HLIST bindSearchBaseList(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from
								/// a \b mvIMPACT::acquire::DeviceManager object.
								Device* pDev,
								/// [in] The type list to locate
								TDeviceListType deviceListType,
...
public:
		 ...
		 *  image is destroyed.
		 */
		ImageBufferDesc(	/// [in] The source buffer descriptor.
	 ...
	 */
	explicit ImageBufferDesc(	/// [in] The number of channel specific data elements to allocate
								/// memory for.
	 ...
	 */
	explicit ImageBufferDesc(	/// [in] The desired pixel format for the new \b mvIMPACT::acquire::ImageBuffer
...
public:
	...
	explicit Request(	/// [in] A constant reference to the \b mvIMPACT::acquire::Request object, this object shall be created from
	 ...
	 */
	DeviceComponentLocator getComponentLocator( void ) const { return m_pRefData->m_locator; }
...
#	ifndef WRAP_DOTNET
		mvIMPACT::
#	endif // #	ifndef WRAP_DOTNET
		Image getIMPACTImage(	/// [in] Flags defining how the buffer is created and behaves.
...
#	endif
	...
	unsigned int getChunkCounterCount( void ) const { return static_cast<unsigned int>(m_pRefData->m_chunkCounterValues.size()); }
		 ...
		 *  For additional information about the chunk data format please refer to \ref ImageAcquisition_section_chunk.
		 */
		PropertyI64 getChunkCounterValue(	/// [in] The index of the counter to return
											unsigned int index ) const { return PropertyI64(m_pRefData->m_chunkCounterValues.at( index )->hObj()); }
	 ...
	 *  For additional information about the chunk data format please refer to \ref ImageAcquisition_section_chunk.
	 */
	PropertyF getChunkTimerValue(	/// [in] The index of the timer to return
									unsigned int index ) const { return PropertyF(m_pRefData->m_chunkTimerValues.at( index )->hObj()); }
	 ...
	 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR otherwise.
	 */
	int attachUserBuffer(	/// [in] A pointer to a user supplied buffer
							void* pBuf,
...
PYTHON_ONLY(%mutable;)
	...
	PropertyI64 getInfoFrameID( void ) const { return infoFrameID; }
	PropertyI64 getInfoFrameNr( void ) const { return infoFrameNr; }
...
public:
	...
	explicit ImageRequestControl(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a 
...
public:
#if defined(WRAP_DOTNET) || defined(DOTNET_ONLY_CODE)
	virtual Request* createRequest(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from
									/// a \b mvIMPACT::acquire::>DeviceManager object.
									Device* pDev,
...
public:
	 ...
	 *  \b Device::open
	 */
	explicit FunctionInterface(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from
								/// a \b mvIMPACT::acquire::DeviceManager object.
								Device* pDev,
	...
	explicit FunctionInterface(	/// [in] A constant reference to the \b mvIMPACT::acquire::FunctionInterface object, this object shall be created from
	 ...
	 */
	int createImageRequestControl(	/// [in] The name of the new \b mvIMPACT::acquire::ImageRequestControl object.
									const std::string& name,
	 ...
	 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR or \b mvIMPACT::acquire::TPROPHANDLING_ERROR otherwise.
	 */
	int createSetting(	/// [in] The name of the setting to be created.
						const std::string& name,
	 ...
	 */
	Request* getRequest(	/// [in] The number of the request to return
							int nr ) const
	{
		updateRequests();
	 ...
	 */
	ComponentList getSetting(	/// [in] The name of the setting to locate
	 ...
	 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR otherwise.
	 */
	int imageRequestConfigure(	/// [in] A const pointer to the request object to configure
	 ...
	 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR otherwise.
	 */
	int imageRequestReset(	/// [in] The \b mvIMPACT::acquire::ImageRequestControl for which all
	...
	int imageRequestUnlock(	/// [in] The number of the request to unlock. This is typically
							...
							/// \b mvIMPACT::acquire::FunctionInterface::imageRequestWaitFor.
							int nr ) const { return DMR_ImageRequestUnlock( m_pRefData->m_pDevice->hDrv(), nr ); }
	 ...
	 */
	int imageRequestWaitFor(	/// [in] The maximum wait time in milliseconds (ms) for
	 ...
	 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR otherwise.
	 */
	int getCurrentCaptureBufferLayout(	/// [in] A reference to the \b mvIMPACT::acquire::ImageRequestControl object 
	 ...
	 *  - false otherwise.
	 */
	MVIMPACT_DEPRECATED_CPP( bool isRequestOK(	/// [in] The request to check
	 ...
	 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR or \b mvIMPACT::acquire::TPROPHANDLING_ERROR otherwise.
	 */
	int loadSetting(	/// [in] The name or the full path under where the setting is located
						const std::string& name,
	 ...
	 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR or \b mvIMPACT::acquire::TPROPHANDLING_ERROR otherwise.
	 */
	int loadSettingFromDefault(	/// [in] Specifies where the information is located.
	 ...
	 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR or \b mvIMPACT::acquire::TPROPHANDLING_ERROR otherwise.
	 */
	int saveSetting(	/// [in] The name or the full path under which this setting shall be stored
						const std::string& name,
	 ...
	 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR or \b mvIMPACT::acquire::TPROPHANDLING_ERROR otherwise.
	 */
	int saveSettingToDefault(	/// [in] Specifies where the information shall be stored.
...
#	ifndef WRAP_PYTHON
	 ...
	 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR or \b mvIMPACT::acquire::TPROPHANDLING_ERROR otherwise.
	 */
	MVIMPACT_DEPRECATED_CPP( int saveSystemToDefault(	/// [in] Specifies where the information shall be stored.
...
public:
	...
	explicit Info(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
...
public:
	...
	explicit BasicDeviceSettings(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
									Device* pDev,
...
public:
	...
	explicit ImageDestination(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
								Device* pDev,
								/// [in] The name of the driver internal setting to access with this instance.
								/// A list of valid setting names can be obtained by a call to
								/// \b mvIMPACT::acquire::FunctionInterface::getAvailableSettings, new
...
public:
	...
	explicit ImageProcessing(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
								Device* pDev,
								/// [in] The name of the driver internal setting to access with this instance.
								/// A list of valid setting names can be obtained by a call to
								/// \b mvIMPACT::acquire::FunctionInterface::getAvailableSettings, new
	...
	explicit ImageProcessing(	/// [in] A constant reference to the \b mvIMPACT::acquire::ImageProcessing object, this object shall be created from
...
PYTHON_ONLY(%mutable;)
	...
	PropertyIBoolean getChannelSplitDeinterlaceEnable( void ) const { return channelSplitDeinterlaceEnable; }
	PropertyIBoolean getColorTwistInputCorrectionMatrixEnable( void ) const { return colorTwistInputCorrectionMatrixEnable; }
	PropertyIColorTwistInputCorrectionMatrixMode getColorTwistInputCorrectionMatrixMode( void ) const { return colorTwistInputCorrectionMatrixMode; }
	PropertyF getColorTwistInputCorrectionMatrixRow0( void ) const { return colorTwistInputCorrectionMatrixRow0; }
	PropertyF getColorTwistInputCorrectionMatrixRow1( void ) const { return colorTwistInputCorrectionMatrixRow1; }
	PropertyF getColorTwistInputCorrectionMatrixRow2( void ) const { return colorTwistInputCorrectionMatrixRow2; }
	...
	PropertyIBoolean getColorTwistOutputCorrectionMatrixEnable( void ) const { return colorTwistOutputCorrectionMatrixEnable; }
	PropertyIColorTwistOutputCorrectionMatrixMode getColorTwistOutputCorrectionMatrixMode( void ) const { return colorTwistOutputCorrectionMatrixMode; }
	PropertyF getColorTwistOutputCorrectionMatrixRow0( void ) const { return colorTwistOutputCorrectionMatrixRow0; }
	PropertyF getColorTwistOutputCorrectionMatrixRow1( void ) const { return colorTwistOutputCorrectionMatrixRow1; }
	PropertyF getColorTwistOutputCorrectionMatrixRow2( void ) const { return colorTwistOutputCorrectionMatrixRow2; }
	PropertyF getColorTwistResultingMatrixRow0( void ) const { return colorTwistResultingMatrixRow0; }
	PropertyF getColorTwistResultingMatrixRow1( void ) const { return colorTwistResultingMatrixRow1; }
	PropertyF getColorTwistResultingMatrixRow2( void ) const { return colorTwistResultingMatrixRow2; }
#endif // #ifdef DOTNET_ONLY_CODE
	 ...
	 */
	void setSaturation(	/// [in] The saturation value.
						double K )
	{
	 ...
	 */
	GainOffsetKneeChannelParameters& getGainOffsetKneeParameter(	/// [in] The index of the gain, offset, knee parameter set to be returned
																	unsigned int index ) const { return *(m_pRefData->m_GainOffsetKneeParameters.at( index )); }
	 ...
	 *  can be altered by the user.
	 */
	MirrorParameters& getMirrorParameter(	/// [in] The index of the mirror parameter set to be returned
											unsigned int index ) const { return *(m_pRefData->m_MirrorParameters.at( index )); }
	 ...
	 *  can be altered by the user.
	 */
	LUTParameters& getLUTParameter(	/// [in] The index of the LUT parameter set to be returned
									unsigned int index ) const { return *(m_pRefData->m_LUTParameters.at( index )); }
	 ...
	 *  can be altered by the user.
	 */
	WhiteBalanceSettings& getWBUserSetting(	/// [in] The index of the white balance parameter set to be returned
											unsigned int index ) const { return *(m_pRefData->m_WBUserSettings.at( index )); }
...
public:
	explicit StatisticsBase(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
...
public:
	...
	explicit Statistics(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
...
protected:
	...
	explicit SystemBase(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
...
PYTHON_ONLY(%mutable;)
	...
	PropertyI getAcquisitionIdleTimeMax_ms( void ) const { return acquisitionIdleTimeMax_ms; }
#endif // #ifdef DOTNET_ONLY_CODE
};
...
#	ifndef IGNORE_MVGRABBER_SPECIFIC_DOCUMENTATION
		...
		public:
			...
			explicit ImageMemoryManager(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
...
#	if !defined(IGNORE_MVBLUEFOX_SPECIFIC_DOCUMENTATION) || !defined(IGNORE_MVBLUECOUGAR_SPECIFIC_DOCUMENTATION) || !defined(IGNORE_MVBLUELYNX_SPECIFIC_DOCUMENTATION)
		...
		public:
			...
			explicit InfoBlueDevice(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
										Device* pDev ) : InfoBase(pDev),
...
#	ifndef IGNORE_MVBLUECOUGAR_SPECIFIC_DOCUMENTATION
		...
		public:
			...
			explicit InfoBlueCOUGAR(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
...
#	ifndef IGNORE_MVBLUEFOX_SPECIFIC_DOCUMENTATION
		...
		public:
			...
			explicit InfoBlueFOX(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
...
#		endif // #ifdef DOXYGEN_SHOULD_SKIP_THIS
	...
	public:
		...
		explicit RTCtrProgram(	/// [in] A constant reference to the \b mvIMPACT::acquire::RTCtrProgram object, this object shall be created from
...
#	endif // #ifndef WRAP_PYTHON (In Python, object assignment amounts to just a reference count increment anyhow; you need to call the constructor or possibly some slice operation to make a true copy)
		...
		void setProgramSize(	/// [in] The new number of program instructions
								int newSize )
		{
		 ...
		 */
		RTCtrProgramStep* programStep(	/// [in] The index of the program instruction to obtain.
...
#	endif // #ifdef DOTNET_ONLY_CODE
	...
	public:
		 ...
		 */
		explicit EventWaitResults(	/// [in] The error code returned by the wait function
									int errorCode,
...
#	ifndef WRAP_PYTHON
			 ...
			 */
			explicit MVIMPACT_DEPRECATED_CPP( EventSubSystem(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
																Device* pDev ) );
#	endif // #ifndef WRAP_PYTHON
		 ...
		 */
		explicit EventSubSystem(	/// [in] A reference to an existing \b mvIMPACT::acquire::EventSubSystem.
...
#	ifndef WRAP_PYTHON
			 ...
			 *  modify the same event obtained from this newly constructed class.
			 */
			EventSubSystem& operator=(	/// [in] A reference to an existing \b mvIMPACT::acquire::EventSubSystem.
...
#	endif // #ifndef WRAP_PYTHON (In Python, object assignment amounts to just a reference count increment anyhow; you need to call the constructor or possibly some slice operation to make a true copy)
		 ...
		 *  - an invalid pointer or reference otherwise.
		 */
		Event* getEventByIndex(	/// [in] The index of the event object the user wants to access.
		 ...
		 *  - an invalid pointer or reference otherwise.
		 */
		Event* getEventByType(	/// [in] The type of the event object the user wants to access.
		 ...
		 *  - an invalid pointer or reference otherwise.
		 */
		Event* getEventByName(	/// [in] The name/string representation of the event object the user wants to access.
								const std::string& name ) const
		{
...
#	ifndef WRAP_PYTHON
			 ...
			 */
			MVIMPACT_DEPRECATED_CPP( EventWaitResults waitFor(	/// [in] The timeout in ms defining the maximum time to be spend waiting
																int timeout_ms,
...
#	endif // DOXYGEN_SHOULD_SKIP_THIS
	public:
		...
		explicit IOSubSystem(	/// [in] A constant reference to the \b mvIMPACT::acquire::IOSubSystem object, this object shall be created from
...
#	endif // #ifndef WRAP_PYTHON (In Python, object assignment amounts to just a reference count increment anyhow; you need to call the constructor or possibly some slice operation to make a true copy)
		 ...
		 *  \endif
		 */
		PulseStartConfiguration* getPulseStartConfiguration(	/// [in] The number of the pulse start configuration to return
		 ...
		 *  \endif
		 */
		RTCtrProgram* getRTCtrProgram(	/// [in] The number of the real time controller program to return
		 ...
		 */
		const DigitalInput* input(	/// [in] The number of the digital input.
		 ...
		 */
		DigitalOutput* output(	/// [in] The number of the digital output.
		 ...
		 * \endcode
		 */
		virtual void writeOutputRegister(	/// [in] The value to be applied to the output register
											unsigned int value,
...
#	ifndef IGNORE_MVBLUEFOX_SPECIFIC_DOCUMENTATION
		...
		public:
			...
			explicit IOSubSystemBlueFOX(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
			 ...
			 *  pin 0 and 1 ( 3 = 00000011 binary ).
			 */
			void writeOutputRegister(	/// [in] The value to be applied to the output register
										unsigned int value,
										/// [in] The mask to specify which pins to modify. A bit
										/// set to '1' in this parameter means that the
										/// state of this output has to adopt its style according to
			 ...
			 *  pin 0 and 1 ( 3 = 00000011 binary ).
			 */
			void writeOutputRegisterAtomic(	/// [in] The value to be applied to the output register
											unsigned int value,
											/// [in] The mask to specify which pins to modify. A bit
											/// set to '1' in this parameter means that the
											/// state of this output has to adopt its style according to
...
#	if !defined(IGNORE_MVGRABBER_SPECIFIC_DOCUMENTATION) || !defined(IGNORE_MVBLUECOUGAR_SPECIFIC_DOCUMENTATION)
		...
		public:
			...
			explicit IOSubSystemCommon(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
...
#		endif // #ifdef DOXYGEN_SHOULD_SKIP_THIS
		public:
			...
			explicit OutputSignalGeneratorBlueDevice(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
			...
			/// and exisiting one.
			explicit OutputSignalGeneratorBlueDevice(	/// [in] A constant reference to the \b mvIMPACT::acquire::OutputSignalGeneratorBlueDevice object, this object shall be created from
...
#		endif // #ifndef WRAP_PYTHON (In Python, object assignment amounts to just a reference count increment anyhow; you need to call the constructor or possibly some slice operation to make a true copy)
			 ...
			 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR otherwise.
			 */
			int undefineSignal(	/// [in] A pointer to a \b mvIMPACT::acquire::DigitalOutput object
			...
			bool canCreateExposeActiveSignal(	/// [in] A pointer to a \b mvIMPACT::acquire::DigitalOutput object
												/// obtained from an instance of the class \b mvIMPACT::acquire::IOSubSystemCommon
												/// for this device.
			...
			bool canInvertSignal(	/// [in] A pointer to a \b mvIMPACT::acquire::DigitalOutput object
									/// obtained from an instance of the class \b mvIMPACT::acquire::IOSubSystemCommon
									/// for this device.
									DigitalOutput* pOutput ) const
			{
			...
			TDeviceDigitalOutputMode getOutputMode(	/// [in] A pointer to a \b mvIMPACT::acquire::DigitalOutput object
													/// obtained from an instance of the class \b mvIMPACT::acquire::IOSubSystemCommon
													/// for this device.
													DigitalOutput* pOutput ) const
			{
			...
			bool isOutputModeActive(	/// [in] A pointer to a \b mvIMPACT::acquire::DigitalOutput object
										/// obtained from an instance of the class \b mvIMPACT::acquire::IOSubSystemCommon
										/// for this device.
										DigitalOutput* pOutput,
			...
			bool isSignalInverted(	/// [in] A pointer to a \b mvIMPACT::acquire::DigitalOutput object
									/// obtained from an instance of the class \b mvIMPACT::acquire::IOSubSystemCommon
									/// for this device.
									DigitalOutput* pOutput ) const
			{
			 ...
			 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR otherwise.
			 */
			int setOutputMode(	/// [in] A pointer to a \b mvIMPACT::acquire::DigitalOutput object
								/// obtained from an instance of the class \b mvIMPACT::acquire::IOSubSystemCommon
								/// for this device.
								DigitalOutput* pOutput,
...
#	ifndef IGNORE_MVGRABBER_SPECIFIC_DOCUMENTATION
		...
		public:
			 ...
			 */
			SyncOutput* HDOutput(	/// [in] The number of the HD output to return.
			 ...
			 *  \return A pointer to a \b mvIMPACT::acquire::SyncOutput object.
			 */
			SyncOutput* VDOutput(	/// [in] The number of the VD output to return.
...
#		endif // #ifdef DOXYGEN_SHOULD_SKIP_THIS
		public:
			...
			explicit OutputSignalGeneratorFrameGrabber(	/// [in] A constant reference to the \b mvIMPACT::acquire::OutputSignalGeneratorFrameGrabber object, this object shall be created from
...
#		endif // #ifndef WRAP_PYTHON (In Python, object assignment amounts to just a reference count increment anyhow; you need to call the constructor or possibly some slice operation to make a true copy)
			 ...
			 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR otherwise.
			 */
			int definePulse(	/// [in] A pointer to a \b mvIMPACT::acquire::DigitalOutput object
			 ...
			 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR otherwise.
			 */
			int definePulseSequence(	/// [in] A pointer to a \b mvIMPACT::acquire::DigitalOutput object
										/// obtained from an instance of the class \b mvIMPACT::acquire::IOSubSystemFrameGrabber
										/// for this device.
										DigitalOutput* pOutput,
...
#		ifndef WRAP_DOTNET
				 ...
				 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR otherwise.
				 */
				int getValidSignalsForPassThroughModes(	/// [in] A pointer to a \b mvIMPACT::acquire::DigitalOutput object
														/// obtained from an instance of the class \b mvIMPACT::acquire::IOSubSystemFrameGrabber
														/// for this device.
														DigitalOutput* pOutput,
...
#		endif // WRAP_DOTNET
			...
			unsigned int getValidPassThroughSignalCount(	/// [in] A pointer to a \b mvIMPACT::acquire::DigitalOutput object
															/// obtained from an instance of the class \b mvIMPACT::acquire::IOSubSystemFrameGrabber
															/// for this device.
															DigitalOutput* pOutput ) const
			{
			 ...
			 *  \endif
			 */
			TDigitalSignal getValidPassThroughSignalValue(	/// [in] A pointer to a \b mvIMPACT::acquire::DigitalOutput object
															/// obtained from an instance of the class \b mvIMPACT::acquire::IOSubSystemFrameGrabber
															/// for this device.
															DigitalOutput* pOutput,
			 ...
			 *  \endif
			 */
			std::string getValidPassThroughSignalString(	/// [in] A pointer to a \b mvIMPACT::acquire::DigitalOutput object
															/// obtained from an instance of the class \b mvIMPACT::acquire::IOSubSystemFrameGrabber
															/// for this device.
															DigitalOutput* pOutput,
															/// [in] The index of the entry to read from the property. The find out the last valid value for this parameter
			 ...
			 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR otherwise.
			 */
			int definePassThroughSignal(	/// [in] A pointer to a \b mvIMPACT::acquire::DigitalOutput object
											/// obtained from an instance of the class \b mvIMPACT::acquire::IOSubSystemFrameGrabber
											/// for this device.
											DigitalOutput* pOutput,
			 ...
			 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR otherwise.
			 */
			int defineLineScanPulse(	/// [in] A pointer to a \b mvIMPACT::acquire::DigitalOutput object
										/// obtained from an instance of the class \b mvIMPACT::acquire::IOSubSystemFrameGrabber
										/// for this device.
										DigitalOutput* pOutput,
...
#	ifndef IGNORE_MVBLUECOUGAR_SPECIFIC_DOCUMENTATION
		...
		public:
			...
			explicit IOSubSystemBlueCOUGAR(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
...
#	endif // #ifndef IGNORE_MVBLUECOUGAR_SPECIFIC_DOCUMENTATION
	...
	public:
		...
		explicit Connector(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
							Device* pDev,
							/// [in] The name of the driver internal setting to access with this instance.
							/// A list of valid setting names can be obtained by a call to
							/// \b mvIMPACT::acquire::FunctionInterface::getAvailableSettings, new
...
#	endif // #ifdef DOTNET_ONLY_CODE
	...
	public:
		...
		explicit CameraSettingsBase(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
										Device* pDev,
										/// [in] The name of the driver internal setting to access with this instance.
										/// A list of valid setting names can be obtained by a call to
										/// \b mvIMPACT::acquire::FunctionInterface::getAvailableSettings, new
...
#	ifndef IGNORE_MVVIRTUALDEVICE_SPECIFIC_DOCUMENTATION
		...
		public:
			...
			explicit CameraSettingsVirtualDevice(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
													Device* pDev,
													/// [in] The name of the driver internal setting to access with this instance.
													/// A list of valid setting names can be obtained by a call to
													/// \b mvIMPACT::acquire::FunctionInterface::getAvailableSettings, new
...
#	ifndef IGNORE_MVV4L2_SPECIFIC_DOCUMENTATION
		...
		public:
			...
			explicit CameraSettingsV4L2Device(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
												Device* pDev,
												/// [in] The name of the driver internal setting to access with this instance.
												/// A list of valid setting names can be obtained by a call to
												/// \b mvIMPACT::acquire::FunctionInterface::getAvailableSettings, new
...
#		endif // #ifdef DOTNET_ONLY_CODE
		...
		public:
			...
			explicit CameraSettingsBlueDevice(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
												Device* pDev,
												/// [in] The name of the driver internal setting to access with this instance.
												/// A list of valid setting names can be obtained by a call to
												/// \b mvIMPACT::acquire::FunctionInterface::getAvailableSettings, new
...
#		endif // #ifndef WRAP_PYTHON (In Python, object assignment amounts to just a reference count increment anyhow; you need to call the constructor or possibly some slice operation to make a true copy)
			 ...
			 *  - false otherwise
			 */
			bool isAvailable( void ) const { return m_pRefData->m_boAvailable; }
			 ...
			 */
			HDRKneePoint& getHDRKneePoint(	/// [in] The number of the knee point to be returned
...
#	ifndef IGNORE_MVBLUEFOX_SPECIFIC_DOCUMENTATION
		...
		public:
			...
			explicit CameraSettingsBlueFOX( /// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
											Device* pDev,
											/// [in] The name of the driver internal setting to access with this instance.
											/// A list of valid setting names can be obtained by a call to
											/// \b mvIMPACT::acquire::FunctionInterface::getAvailableSettings, new
...
#		ifdef DOTNET_ONLY_CODE
			PropertyIAutoOffsetCalibration getOffsetAutoCalibration( void ) const { return offsetAutoCalibration; }
			PropertyF getOffsetCorrection_pc( void ) const { return offsetCorrection_pc; }
...
#	ifndef IGNORE_MVBLUECOUGAR_SPECIFIC_DOCUMENTATION
		...
		public:
			...
			explicit CameraSettingsBlueCOUGAR(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
												Device* pDev,
												/// [in] The name of the driver internal setting to access with this instance.
												/// A list of valid setting names can be obtained by a call to
												/// \b mvIMPACT::acquire::FunctionInterface::getAvailableSettings, new
			 ...
			 */
			const TriggerControl* triggerControl(	/// [in] The number of the trigger control
			...
			const TriggerControl* triggerControl(	/// [in] The name of the trigger control
													const std::string& name ) const
			{
...
#	ifndef IGNORE_MVGRABBER_SPECIFIC_DOCUMENTATION
		...
		public:
			...
			explicit CameraSettingsFrameGrabber(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
													Device* pDev,
													/// [in] The name of the driver internal setting to access with this instance.
													/// A list of valid setting names can be obtained by a call to
													/// \b mvIMPACT::acquire::FunctionInterface::getAvailableSettings, new
...
#		endif // #ifdef DOTNET_ONLY_CODE
		...
		public:
			 ...
			 *  - A negative error code of type \b mvIMPACT::acquire::TDMR_ERROR or \b mvIMPACT::acquire::TPROPHANDLING_ERROR otherwise.
			 */
			int copyDescription(	/// [in] The name for the newly created camera description. This name
...
#			endif // #ifdef DOXYGEN_SHOULD_SKIP_THIS
		...
		public:
			...
			explicit CameraDescriptionManager(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::>DeviceManager object.
												Device* pDev ) : m_pRefData(0)
			{
				if( !pDev->isOpen() )
				{
...
#			endif // #ifndef WRAP_PYTHON (In Python, object assignment amounts to just a reference count increment anyhow; you need to call the constructor or possibly some slice operation to make a true copy)
			 ...
			 *  \endif
			 */
			CameraDescriptionCameraLink* cameraDescriptionCameraLink(	/// [in] The index of the camera description to return
																		unsigned int index ) const
			{
				update();
			 ...
			 *  - an invalid pointer or reference otherwise.
			 */
			CameraDescriptionCameraLink* cameraDescriptionCameraLink(	/// [in] The name of the camera description. This can either be 
			 ...
			 *  \endif
			 */
			CameraDescriptionSDI* cameraDescriptionSDI(	/// [in] The index of the camera description to return
														unsigned int index ) const
			{
				update();
			 ...
			 *  - an invalid pointer or reference otherwise.
			 */
			CameraDescriptionSDI* cameraDescriptionSDI(	/// [in] The name of the camera description. This can either be 
														/// the name of the list like e.g. 'CameraLink_Generic' or the 
														/// value of the property 'name' of this description like
														/// e.g. 'Generic'.
														const std::string& name ) const
			 ...
			 *  \endif
			 */
			CameraDescriptionDigital* cameraDescriptionDigital(	/// [in] The index of the camera description to return
																unsigned int index ) const
			{
				update();
			 ...
			 *  - an invalid pointer or reference otherwise.
			 */
			CameraDescriptionDigital* cameraDescriptionDigital(	/// [in] The name of the camera description. This can either be 
			 ...
			 *  \endif
			 */
			CameraDescriptionStandard* cameraDescriptionStandard(	/// [in] The index of the camera description to return
																	unsigned int index ) const
			{
				update();
			 ...
			 *  - an invalid pointer or reference otherwise.
			 */
			CameraDescriptionStandard* cameraDescriptionStandard(	/// [in] The name of the camera description. This can either be 
			 ...
			 *  \endif
			 */
			CameraDescriptionNonStandard* cameraDescriptionNonStandard(	/// [in] The index of the camera description to return
																		unsigned int index ) const
			{
				update();
			 ...
			 *  - an invalid pointer or reference otherwise.
			 */
			CameraDescriptionNonStandard* cameraDescriptionNonStandard(	/// [in] The name of the camera description. This can either be 
...
#	ifndef IGNORE_MVBLUEFOX_SPECIFIC_DOCUMENTATION
		...
		public:
			...
			explicit I2CControl(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
...
#		endif // #ifdef DOTNET_ONLY_CODE
			 ...
			 */
			std::string I2CRead(	/// [in] The address of the I2C device to communicate with.
									int deviceAddress,
			 ...
			 *  \b mvIMPACT::acquire::I2CControl::I2COperationStatus should be checked afterwards.
			 */
			void I2CWrite(	/// [in] The address of the I2C device to communicate with.
							int deviceAddress,
							/// [in] The sub-address of the I2C device to communicate with.
							int deviceSubAddress,
							/// [in] The sub-address width(in bits) of the I2C device to communicate with.
...
#	endif // #ifndef IGNORE_MVBLUEFOX_SPECIFIC_DOCUMENTATION
	...
	public:
		...
		explicit MotorFocusControl(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
...
#	ifndef IGNORE_MVBLUEFOX_SPECIFIC_DOCUMENTATION
		...
		public:
			...
			explicit DigitalIOMeasurementControl(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
...
#	endif // #ifndef IGNORE_MVBLUEFOX_SPECIFIC_DOCUMENTATION
	...
	public:
		...
		explicit FullSettingsBase(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
									Device* pDev,
									/// [in] The name of the driver internal setting to access with this instance.
									/// A list of valid setting names can be obtained by a call to
									/// \b mvIMPACT::acquire::FunctionInterface::getAvailableSettings, new
...
#	ifndef IGNORE_MVGRABBER_SPECIFIC_DOCUMENTATION
		...
		public:
			...
			explicit SettingsFrameGrabber(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
											Device* pDev,
											/// [in] The name of the driver internal setting to access with this instance.
											/// A list of valid setting names can be obtained by a call to
											/// \b mvIMPACT::acquire::FunctionInterface::getAvailableSettings, new
...
#	ifndef IGNORE_MVBLUEFOX_SPECIFIC_DOCUMENTATION
		...
		public:
			...
			explicit SystemBlueFOX(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
...
#	ifndef IGNORE_MVV4L2_SPECIFIC_DOCUMENTATION
		...
		public:
			...
			explicit SystemV4L2(	/// [in] A pointer to a \b mvIMPACT::acquire::Device object obtained from a \b mvIMPACT::acquire::DeviceManager object.
