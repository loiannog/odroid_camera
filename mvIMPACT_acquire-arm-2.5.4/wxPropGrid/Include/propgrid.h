...
#elif (wxUSE_VALIDATORS == 0)
    #error "This code needs wxWidgets to be compiled with wxUSE_VALIDATORS enabled."
#endif
...
// automatically should be added in future.
    ...
    */
    ...
    const wxColour& GetTextColour( void ) const { return m_textColour; }
    ...
    */
    ...
    %pythoncode {
        ...
        def GetPropertyValues(self,dict_=None,as_strings=False):
            ...
            "  object as well, in which case its __dict__ is used."
	...
	/** Sets property as read-only. Its value cannot be changed by the user, but the
...
public:
    ...
    */
    ...
    void ClearOnHoverProp( void ) { m_propHover = (wxPGProperty*)NULL; }
    ...
    */
    ...
    /** Returns splitter x ratio after the splitter has been moved otherwise -1. */
    inline double GetSplitterRatio () const { return m_splitterxRatio; }

    /** Initialize the splitter x ratio variable. Splitter position will not be changed */
    inline void SetSplitterRatio ( double ratio ) { m_splitterxRatio = ratio; }
    ...
    */
    ...
    /** Sets text colour of a category caption (but not its children).
    */
...
protected:
    ...
    */
    ...
    double              m_splitterxRatio; // ratio info of splitter position to the width after moving the splitter, 
                                          // for external use only (Get/Set), no internal functionality
...
public:
    ...
    wxPropertyGrid* GetPropertyGrid( void ) const { return m_pg; }
private:
